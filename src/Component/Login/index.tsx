...
const Login: React.FC<LoginProps> = ({ isVisible, onClose }) => {
  ...
  return (
    <div onClick={handleClose} id="wrapper" className="fixed inset-0 z-50 bg-black bg-opacity-15 backdrop-blur-sm shadow-sm flex justify-center items-center">
      <div className=" w-1/3">
        {/* <!-- component --> */}
        <div className="bg-[#002f34] text-white flex h-[600px] rounded-xl flex-col items-center sm:justify-center sm:pt-0">
          ...
          <div className="text-foreground font-semibold text-2xl tracking-tighter mx-auto  gap-2">
            <img className="w-28 m-auto mb-3" src={Logo} alt="Logo" />
          ...
          <div className="flex items-center px-5 mt-2 h-12 w-full gap-3">
            <a><img className="cursor-pointer hover:border-2 hover:border-white rounded-md" src={GoogleBtn} alt="" /></a>
            <a><img className="cursor-pointer hover:border-2 hover:border-white rounded-md" src={FBBtn} alt="" /></a>
          </div>
